...
from activities import speechToText
...
def process_blob(context):
    ...
    if file_extension in audio_extensions:
        ...
        # stt_input = {
        #     "name": blob_name,          # just the blob name
        #     "uri": blob_input.get("uri")  # full URI from the blob trigger
        # }
        # text_result = yield context.call_activity("speechToText", stt_input)
